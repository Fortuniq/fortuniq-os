...
import {
  ...
  ExternalLink, FolderSync, FileText, Folder, X,
} from "lucide-react";
...
import {
  ...
  updateSubmissionInfo, retryTenderFolderCreation,
} from "../tender-actions";
    ...
    <Card className="max-w-xl">
      <CardBody>
        <div className="flex items-center justify-between mb-4">
          <p className="text-sm text-grey">{completedCount} of {tender.checklist.length} confirmed</p>
          <p className="text-xs text-light-grey">Manually entered compliance: {tender.compliance}%</p>
        </div>
        ...
        <p className="text-[11px] text-light-grey mt-3">
          Automatic compliance calculation from these confirmed items (replacing the manual percentage above) is
          coming in the next phase — see docs/TENDER_WORKSPACE.md.
        </p>
      </CardBody>
    </Card>
  );
