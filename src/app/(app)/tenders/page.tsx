import { getTenders, getTenderChecklist, getTenderWorkflowCounts } from "@/lib/data";
...
export default async function TendersPage() {
  ...
  const [tenders, checklist, canCreate, workflowCounts] = await Promise.all([
    getTenders(),
    getTenderChecklist(),
  ...
  return <TendersView tenders={tenders} checklist={checklist} canManage={canCreate} workflowCounts={workflowCounts} />;
}
